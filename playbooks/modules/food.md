...
2. In a power cut, keep fridge and freezer doors shut: a fridge holds its temperature for about 4 hours, a full freezer for 48 hours, a half-full one for 24 hours. Discard any chilled food that has been above 8 °C for more than 4 hours ([FSA chill, freeze and defrost](kiwix:govuk_resilience/www.gov.uk/government/publications/how-to-chill-freeze-and-defrost-food-safely)).
3. Cook without mains power on a gas hob lit with a match, or a camping stove used only in a ventilated space; never use a barbecue or a generator indoors, even in a doorway or open window ([Carbon monoxide card](card:carbon-monoxide)).
