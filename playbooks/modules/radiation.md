...
- Radiation sickness is judged in the field by time to vomiting: within an hour means a severe dose, 1 to 2 hours serious, 2 to 4 hours moderate, and none in 6 hours is probably a low dose. Doses above about 6 Gy are usually fatal without intensive care, while 1 to 2 Gy is survivable with nursing care ([acute radiation syndrome](kiwix:wikipedia_en_all_maxi/Acute_radiation_syndrome); [FEMA, p. 97](doc:fema-nuclear-detonation-2022#page=97)). The first-aid steps are on the [radiation sickness card](card:radiation-sickness).
...
4. {{#if water}}Decontaminate by removing your outer clothing and bagging it, which alone takes off up to 90% of the contamination, then showering with soap, no conditioner, without scrubbing, which removes most of what is left{{else}}Decontaminate by removing your outer clothing and bagging it, which alone takes off up to 90% of the contamination, then washing with soap and stored water poured from a jug, hair last, no conditioner and no scrubbing, or wiping down with a damp cloth if water is short, which removes most of what is left{{/if}} ([UKHSA decontamination, p. 1](doc:ukhsa-radiation-decontamination#page=1); [FEMA, p. 40](doc:fema-nuclear-detonation-2022#page=40)). Once decontaminated, the risk to whoever nurses them is very low.
...
**Fallout comes down within minutes to hours wherever the wind carries it, so shelter beats everything else.** Stay in the fall-out room, and in the inner refuge, for at least 24 hours, the current minimum, and expect 48 hours or more where fallout is heavy, which was the old civil-defence figure; take that decision from the radio, not by looking outside ([Protect and Survive, p. 15](doc:protect-and-survive-1980#page=15); [FEMA, p. 74](doc:fema-nuclear-detonation-2022#page=74)). While fallout is still falling, do not strip: dust yourself down without breathing it, and take the outer layer off under cover ([FEMA, p. 116](doc:fema-nuclear-detonation-2022#page=116)). Trips outside in the first days are minutes long and made by adults over 40, whose thyroid risk is negligible ([NRPB, p. 16](doc:nrpb-stable-iodine#page=16)).
{{/if}}

{{#if scenario:nuclear-accident}}
**This is a plume, not a battlefield: go in, stay in, tune in.** Shelter in the nearest solid building rather than driving home or to the school; children are kept in and told what to do ([UKHSA, what to do](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public/what-to-do-in-a-radiation-emergency)). Sheltering is usually advised over evacuation and may last one to two days, a vehicle gives no useful shelter, and leaving shelter early can increase your dose. Inside the Detailed Emergency Planning Zone around a licensed site some operators pre-distribute tablets and instructions to households, though that is site-specific rather than universal, so check your local off-site plan ([REPPIR 2019](kiwix:legislation_uk/www.legislation.gov.uk/uksi/2019/703/contents)); and you still take the iodine only when the authorities say ([NRPB, p. 9](doc:nrpb-stable-iodine#page=9)).
{{/if}}
...
- [Radiological injuries, Emergency War Surgery](doc:emergency-war-surgery-2018#page=448)
- [Nuclear sites on the map](map:?overlay=nuclear-sites)
