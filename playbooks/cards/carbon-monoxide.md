...
{{#unless power}}
The power cut is what causes this. A generator runs outside, well away from doors, windows and air bricks, never in a garage, porch or shed, with the cable run in through a window. Camping stoves and barbecues are for outdoors only, and a stove lit indoors for warmth is the classic way a family dies in a power cut. Keep a battery CO alarm in the room where anything burns and test it; the mains-powered alarm on the ceiling is off with everything else ([Power module](module:power)).
{{/unless}}
...
This is the scenario that fills hospitals with carbon monoxide poisoning: generators, stoves, barbecues and unflued heaters brought indoors for warmth, and flues and air bricks blocked by snow. Clear snow away from the boiler flue and the air bricks, keep a window or vent open in any room where something is burning, sleep with the alarm within earshot, and warm people rather than rooms with layers and sleeping bags ([Shelter and heat](module:shelter-heat); [hypothermia](card:hypothermia)).
{{/if}}
