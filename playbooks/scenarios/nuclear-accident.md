...
**Go in, stay in, tune in.** Get indoors, shut doors and windows, turn off fans, extractor fans and the boiler flue's air supply if you can, and listen to the radio or wait for the Emergency Alert ([UKHSA radiation emergencies](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public)). This is the government's standing instruction for any release ([NRR 2025, p. 22](doc:nrr-2025#page=22)). Shelter in the nearest building, not at home if home is a journey away, and do not go out to collect children from school or nursery: they will be kept in and told what to do ([UKHSA, what to do](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public/what-to-do-in-a-radiation-emergency)).

**If you were outside in the plume or near an explosion:** outer clothing off at the door into a bag, then wash; the steps are in the [radiation module](module:radiation) below. A person who has washed is not radioactive and is safe to be with ([UKHSA decontamination sheet, p. 1](doc:ukhsa-radiation-decontamination#page=1)).

**A dirty bomb is a bomb first.** Treat the casualties for blast and bleeding ([Severe bleeding card](card:severe-bleeding)); the radiation is a localised, secondary problem, handled as the [radiation module](module:radiation) says ([NRR 2025, p. 40](doc:nrr-2025#page=40)).

**Do not take iodine tablets on your own initiative**; the authorities will say if and when ([NRPB, p. 8](doc:nrpb-stable-iodine#page=8)).
...
- **Follow the instruction for your zone.** Around every licensed site the council holds an off-site plan with a Detailed Emergency Planning Zone in which tablets and advice are pre-distributed ([REPPIR 2019](kiwix:legislation_uk/www.legislation.gov.uk/uksi/2019/703/contents)). Sheltering is usually advised over evacuation: you may be asked to stay in for one to two days, a vehicle gives no useful shelter, and leaving shelter can increase your dose ([UKHSA, what to do](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public/what-to-do-in-a-radiation-emergency)).
- **Iodine, if and when told.** The doses by age and who has priority are in the [radiation module](module:radiation); over-40s gain almost nothing from the tablets ([NRPB, p. 16](doc:nrpb-stable-iodine#page=16)).
...
- **Animals in.** Shut poultry and pets in, bring livestock under cover and feed them stored feed and covered water ([Livestock module](module:livestock)); a pet that was out in the plume is washed with soap and water, gloves on, before anyone handles it ([UKHSA, what to do](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public/what-to-do-in-a-radiation-emergency)).
...
- Expect a **milk and produce ban** in the affected area, as after the 1957 Windscale fire ([Windscale fire](kiwix:wikipedia_en_all_maxi/Windscale_fire)); the Food Standards Agency imposes it and the [radiation module](module:radiation) explains why milk is the route. Discard leafy vegetables and fruit that were outside; wash and peel roots; sealed and stored food is fine.
...
- **Who does what.** The site operator and the council run the off-site plan; UKHSA gives health advice; the Food Standards Agency imposes food restrictions ([REPPIR 2019](kiwix:legislation_uk/www.legislation.gov.uk/uksi/2019/703/contents)).
- **Warnings.** There is no national siren network; a few licensed nuclear and chemical sites have local sirens and loudhailers under REPPIR and COMAH, and the Emergency Alerts phone system is the national warning, backed by local radio ([Prepare, alerts](kiwix:prepare_uk/prepare.campaign.gov.uk/get-prepared-for-emergencies/alerts/); [REPPIR 2019](kiwix:legislation_uk/www.legislation.gov.uk/uksi/2019/703/contents)).
...
- [UKHSA, what to do in a radiation emergency](kiwix:govuk_resilience/www.gov.uk/government/publications/radiation-emergencies-information-for-the-public/what-to-do-in-a-radiation-emergency)
