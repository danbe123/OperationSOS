...
- **Numbers:** the network operator on 105 in Great Britain, or NIE 03457 643 643 in Northern Ireland — [[call 105]]; the rest are on [UK numbers](page:uk-numbers). Landline and mobile behaviour in a power cut is on [What still works](page:what-still-works).
