...
- **Telecoms down:** 999 and 112 may be unreachable for everyone on the affected network; try another phone on another network, a neighbour's landline, or go to the nearest fire station, police station or hospital in person ([NRR 2025, p. 55](doc:nrr-2025#page=55)). What still connects when a network fails is on [What still works](page:what-still-works).
...
The lasting damage from a cyber attack is to records, not wires: where data is destroyed, recovery is measured in months ([NRR 2025, p. 58](doc:nrr-2025#page=58)), and some of it "would be unrecoverable from backups" ([NRR 2025, p. 52](doc:nrr-2025#page=52)). A household's own paper file (prescriptions and test results, policies, statements, the deeds, the will, photographs of the house and its contents) is what gets a claim paid, a prescription re-issued and a balance argued back when the system's copy has gone. Rebuilding the file from that paper is the long-term job; keeping the file current afterwards is the habit that makes the next attack a nuisance instead of a loss ([Prepare](kiwix:prepare_uk/prepare.campaign.gov.uk/get-prepared-for-emergencies/)). If the attack was on the banks and the money itself is in doubt, the [economic collapse playbook](playbook:economic-collapse) takes over.
...
- **Banks:** who acts when a bank fails and how the deposit guarantee works are in the [economic collapse playbook](playbook:economic-collapse).
- **Fuel:** the National Emergency Plan for Fuel and Operation ESCALIN (military tanker drivers) cover regional shortages ([NRR 2025, p. 49](doc:nrr-2025#page=49)); petrol at home stays within the lawful limit (see [vehicles and fuel](module:vehicles-fuel)).
