...
- **Best of a bad lot**: springs, and small fast upland streams above any building, track, grazing or footpath. Go as high and as close to the source as you can. A spring is a raw source like any other and is not automatically clean: most springs are surface-fed, and private supplies from springs, wells and boreholes are generally untreated and carry Campylobacter, E. coli O157, Cryptosporidium and Giardia, so boil or filter it like anything else ([Private water supplies (DWI)](kiwix:govuk_resilience/www.dwi.gov.uk/private-water-supplies/)). Peaty upland water is brown and tastes of soil, and that is fine once treated.
- **Good**: rain. A tarp with a fold, a jacket, a bin bag or a tent fly collects litres in an hour of British rain. Rainwater is not automatically safe to drink, so treat it like any other water, and never take runoff from a roof, a gutter or a downpipe ([Water disinfection](page:water-disinfection)). Dew on grass at dawn soaks a cloth to wring out.
- **Doubtful**: lowland rivers, canals, lakes and ponds, anything below farmland, anything still, anything with foam or a smell. Filter and boil, and prefer another source.
