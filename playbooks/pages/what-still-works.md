...
| Mobile calls and data | Limited | Most mobile masts have about an hour of battery, some a few hours | Parts of the network keep working for a while on back-up power; texts often get through when calls do not; a 999 call roams onto any network with signal ([Prepare, power cuts](kiwix:prepare_uk/prepare.campaign.gov.uk/be-informed-about-hazards/power-cuts/)) |
