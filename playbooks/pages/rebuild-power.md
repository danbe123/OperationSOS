...
- Continuously, that is 7 kWh a day — enough for a few households' lighting, all the charging, a fridge and a pump. Size the scheme on the flow you measure in a dry August, not the one you see in February: British streams commonly fall to a fraction of their winter flow, and summer flow is what you will actually live on.

Measure the flow with a bucket and a pendulum clock — time a ten-litre bucket filling from the full stream, or time a float over a measured channel length, multiply by the cross-section, and then by about 0.85, because the surface runs faster than the average of the channel — and the head with a levelled board or a water-filled hose. Then pick the machine: high head and low flow suit a Pelton wheel made from spoons or split pipe; low head and high flow suit an overshot or breastshot wheel or an Archimedes screw. Overshot wheels are the efficient ones, up to about 90%, while undershot wheels managed around 20% before the 18th century and 50 to 60% once their design was improved ([Water wheel](kiwix:wikipedia_en_all_maxi/Water_wheel); [Water wheel calculations](kiwix:engineering.stackexchange.com_en_all/questions/24083/water-wheel-calculations-required); [Hydraulic wheels and impulse turbines](kiwix:appropedia_en_all/Hydraulic_wheels_and_impulse_turbines); [Microhydro](kiwix:appropedia_en_all/Microhydro)).
...
- A cell sits at about 2.10 V open-circuit when fully charged, so a rested 12 V battery reads about 12.6 V. Float a flooded battery at around 2.27 V per cell — some 13.6 V — and reduce that in a warm place, by roughly 0.2 V on a 12 V battery for every 10 °C above 20 °C. Charge a flooded battery at about 14.4 V, which is deliberately above the voltage at which it starts gassing, and is why the ventilation rule below matters. Sealed AGM and especially gel batteries want less, nearer 13.8 to 14.1 V for gel, and 14.4 V dries them out permanently ([Lead–acid battery](kiwix:wikipedia_en_all_maxi/Lead–acid_battery); [Safe float charge levels](kiwix:electronics.stackexchange.com_en_all/questions/161147/determine-lead-acid-battery-safe-float-charge-level-for-a-range-of-state-of-ch)).
...
- **Charging makes hydrogen.** Overcharging electrolyses the water into hydrogen and oxygen; that mixture explodes, and an exploding battery sprays acid and casing fragments. Hydrogen burns anywhere between 4% and 75% in air, so a closed cupboard reaches an explosive mixture quickly. Charge in a ventilated place, never a sealed cupboard, no flames, no smoking, no sparks; make and break connections at the charger end, away from the battery; and after a hard charge, leave it to air before you disturb the connections.
...
- **Never connect a generator, an inverter or a battery system to the house wiring except through a changeover switch that disconnects the property from the network first.** Back-feeding energises the street cables and can kill someone working on what they believe is a dead line. In England and Wales this is likely to be notifiable work under Part P of the Building Regulations — a new circuit or a change to the consumer unit certainly is — while Scotland and Northern Ireland have their own building standards ([Approved Document P, p. 14](doc:ad-p#page=14); [Mains electricity](page:mains-electricity)). The full rules are on [Mains electricity](page:mains-electricity) and, for panels and islanding, [Solar panels in a power cut](page:solar-islanding).
- **If the mains still exists and you want your generation to run *in parallel* with it** rather than islanded, that is separately regulated and is the commonest real offence here. The Electricity Safety, Quality and Continuity Regulations 2002, regulation 22, require equipment that prevents danger and interference and that disconnects itself when the distributor's supply goes dead, plus advance notice to the network operator. In practice that means notifying under Engineering Recommendation G98 for small units up to 16 A per phase, or applying for and getting approval under G99 above that, **before** you connect ([Solar panels in a power cut](page:solar-islanding); [Islanding](kiwix:wikipedia_en_all_maxi/Islanding)).
