---
id: fieldcraft-shelter
title: Shelter and staying warm
icon: snowflake
order: 14
summary: Getting out of the wind and wet, building with what British woods and moors offer, insulating from the ground, and spotting hypothermia early.
category: fieldcraft
---
...
- Out of the wind, but not in a hollow where cold air and water collect. Halfway up a slope, on the lee side, is the classic choice.
- Off the valley floor and above any watercourse. British rivers rise by metres in a night of rain, and flat grass beside a stream is the first thing to flood ([Storms and flooding playbook](playbook:storms-flooding)).
- Not under dead branches or a lone tree in a storm, and not on the summit or a ridge in wind or lightning.
- Not on bog. Sphagnum moss, cotton grass and rushes mean water; look for heather, bracken and bilberry, which mean drier ground ([Sphagnum](kiwix:wikipedia_en_all_maxi/Sphagnum)).
...
A two by three metre tarp, a bivvy bag and thirty metres of cord weigh under a kilogram and turn any wall or tree into a shelter in ten minutes. The two shapes to know:

- **Lean-to**: one edge pegged to the ground on the windward side, the other edge tied off at knee to waist height between two trees or poles. Low and tight in wind, higher in calm rain. Fire in front if you can have one.
- **A-frame**: a ridge line between two trees, the tarp over it, both sides pegged. Sheds rain best; sit out a storm in it.

Pitch the low side into the wind, peg every corner, and put the ridge line up with a knot you can untie wet and cold ([Rope, knots and tools](page:fieldcraft-rope-tools)). A group shelter, the bright nylon bag a whole party sits inside, is the best-value piece of kit in the British hills.
