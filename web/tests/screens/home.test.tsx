...
describe('Home', () => {
  it('shows the six big tiles in order, the 20 scenario tiles with icons, and the status strip', async () => {
    ...
    expect(bigTitles).toEqual(['MedicalQuick cards, NHS', 'MapsUK and Ireland, offline', 'LibraryWikipedia, manuals, books', 'Phone and radioNumbers, PMR446, what works', 'PlanHousehold, stock, notes, pins', 'ToolsTimers, sun, sums, log']);
