...
const P = {
  ...
  tools: <><path d="M14 6a4 4 0 0 1 5 5l-9 9-3-3 9-9-2-2z" /><path d="M4 20l3-3" /><path d="M5 5l4 4" /></>,
  seedling: <><path d="M12 22V10" /><path d="M12 14c0-4-3-7-8-7 0 4 3 7 8 7z" /><path d="M12 10c0-4 3-7 8-7 0 4-3 7-8 7z" /></>,
  cow: <><path d="M6 8V5M18 8V5" /><path d="M5 8h14v6a7 7 0 0 1-14 0z" /><path d="M9 15h6" /><circle cx="9" cy="11" r="0.8" /><circle cx="15" cy="11" r="0.8" /></>,
  food: <><path d="M6 3v7a2 2 0 0 0 4 0V3" /><path d="M8 10v11" /><path d="M17 3c-2 0-3 3-3 6v3h3v9" /></>,
  ...
  undo: <><path d="M3 10a8 8 0 1 1 2.3 5.7" /><path d="M3 4v6h6" /></>,
