...
CASES: dict[str, tuple[list[tuple[str, str]], str, bool]] = {
    ...
    "checklist-no-now": ([("{#fill-every-bottle-and-the-bath now}", "{#fill-every-bottle-and-the-bath}")],
                         "checklist: no item marked now — the first actions must lead the list", False),
    "checklist-bad-bucket": ([("{#fill-every-bottle-and-the-bath now}", "{#fill-every-bottle-and-the-bath soon}")],
                             "unknown bucket 'soon'", False),
